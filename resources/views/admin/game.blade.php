            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Add Game</h5>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs text-center font-weight-bolder opacity-7">From
                                </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2">
                                        <div>
                                            <img src="{{ asset('storage/' . $games['gambar']) }}" class="avatar avatar-sm rounded-circle me-2">
                                        </div>
                                        <div class="my-auto">
                                            <h6 class="mb-0 text-xs">{{ $games['name'] }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold text-center mb-0">{{ $games['brand']['name'] }}</p>
                                </td>

                                <td class="align-middle ">
                                    <button type="button" class="btn btn-weight-bold text-success"
                                        data-bs-toggle="modal" data-bs-target="#editUser{{ $games['id'] }}">
                                        <i class="material-symbols-rounded">edit_square</i>
                                    </button>
                                    <a href="{{ route('games.delete',$games['id']) }}" class="btn text-danger btn-weight-bold" data-toggle="tooltip"
                                        data-original-title="Edit user" onclick="alert('Apakah yakin ingin menghapus data?')">
                                        <i class="material-symbols-rounded">delete</i>
                                    </a>
                                    <div class="modal fade" id="editUser{{ $games['id'] }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('games.update',$games['id'] ) }}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="form-label">Gambar</label>
                                                                <div class="input-group input-group-outline ">
                                                                    <input type="file" class="form-control" name="gambar" value="{{ $games['gambar'] }}">
                                                                </div>
                                                            </div>
                                                        </div>
